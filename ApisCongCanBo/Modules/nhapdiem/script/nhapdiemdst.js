        ...
        var jsonForm = {
            ...
            aoColumns: [
                ...
                },
                {
                    "mDataP": "TEN",
                    "mRender": function (nRow, aData) {
                        return '<span><a class="btnEdit" style="text-decoration: underline;font-style: italic; color: green; cursor: pointer" id="' + aData.ID + '" title="Chi tiết">' + edu.util.returnEmpty(aData.HINHTHUCTHI_TEN) + '</a></span>';
                    }
                },
                {
                    "mDataP": "TEN",

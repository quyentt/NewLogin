...
NhapDiemLichThi.prototype = {
    ...
    genTable_ThongKe: function (data, iPager) {
        ...
        me.dtTenCot.forEach(e => {
            $("#tblThongKe thead tr").eq(0).append('<th class="text-center border-bottom" scope="col" colspan="2">' + e.TEN + '</th>');
            $("#tblThongKe thead tr").eq(1).append('<th class="text-center fw-normal w-50px">SL</th><th class="text-center fw-normal border-left w-50px px-0">Tỷ lệ %</th>');
        });
        var jsonForm = {

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="phieukhaosat.aspx.cs" Inherits="Apis.NewLogin.pages.phieukhaosat" %>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Mulish:ital,wght@0,400;0,500;0,700;0,800;1,400;1,500;1,700;1,800&display=swap" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="cmc-page">
        <div class="cmc-ks-header">
            <div class="container">
                <div class="d-flex">
                    <div class="cmc-logo">
                        <%--<a class="logo-desk" >
                            <img src="../assets/images/cmc-khaosat/logo.png" alt="">
                        </a>--%>
                        <a class="logo-mobi" >
                            <img src="logokhaosat.jpg" alt="">
                        </a>
                    </div>
        ...
        <div class="cmc-breadcrumb">
            <div class="container">
                <ul>
                    ...
                    <li>Phiếu khảo sát</li>
                </ul>
            </div>
        </div>
        <div class="cmc-con">
            <div class="container">
                <div class="cmc-con-before">
                    <div class="cmc-main-title"  id="lblTieuDe">
                    </div>
                    <%--<a  class="btn">
                ...
                <div class="cmc-suvery">
                    <div class="cmc-suvery-head">
                        <div class="tern-name"  id="lblMoTaPhieu">
                        </div>
                        <%--<div class="d-flex align-items-center">
                            <button class="btn btn-outline-success">
                                <!-- <i class="fal fa-plus"></i> -->
                                <span>Khởi tạo theo phiếu mẫu</span>
                            </button>
                    ...
                    <div class="cmc-suvery-content"  id="tblNoiDung">
        ...
        <div class="line-1 bg-e1 mt-5"></div>
        <div class="cmc-st-search">
            <div class="container d-flex justify-content-center">
                <div class="cmc-st-search-gr">
        ...
        <div class="cmc-footer">
            <div class="container ">
                ...
                <p class="copy-right">© 2023, Khảo Sát Trực Tuyến</p>
            </div>
        </div>
    </div>
...
<script src="phieukhaosat.js?v=<%=  Guid.NewGuid().ToString() %>"></script>
    
<script type="text/javascript">
    var main_doc = {};
    main_doc['KhaoSat'] = new KhaoSat();
    $(document).ready(function () {
        main_doc.KhaoSat.init();
    });
</script>
<%--<script>

...
ThanhToan.prototype = {
    ...
    init: function () {
        ...
        $("#tblThanhToan").delegate(".inputsotien", "blur", function (e) {
    ...
    getList_QRCode: function (code, dSoTien) {
        ...
        if (!strNoiDung && arrChecked_Id.length) strNoiDung = me.dtVanTin.rsChiTiet.find(e => e.ID == arrChecked_Id[0]).NOIDUNG;
